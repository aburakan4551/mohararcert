 ...
 * Production-ready Firebase Provider template for mohararcert.
...
export const firebaseProvider = {
    auth: {
        async login(email, password) {
            throw new Error('Firebase Authentication Provider is not configured yet. Set activeProvider to "local" in db.js.');
        },
